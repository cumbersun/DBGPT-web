  ...
  const contentRender = () => {
    if (scene === 'chat_dashboard') {
      ...
      return isChatDefault ? (
        <Content className='bg-[url(/pictures/empty_bg.png)] bg-cover bg-no-repeat'>
          <ChatDefault />
        </Content>
      ) : (
        <Spin spinning={historyLoading} className='w-full h-full m-auto'>
          <Content className='flex flex-col h-screen bg-[url(/pictures/empty_bg.png)] bg-cover bg-no-repeat'>
